...
const StaffPortal = () => {
  ...
  return (
    <div>
      <PageHeader
        title={staffType === 'academic' ? 'Academic Staff Portal' : 'Administrative Staff Portal'}
        subtitle={staffType === 'academic' 
          ? "Access teaching resources, research tools, and faculty services" 
          : "Access administrative tools, support services, and university resources"}
        background="gradient"
      />
